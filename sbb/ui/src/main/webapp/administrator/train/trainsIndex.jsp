...
<div class = "additionalOptionsList">
    ...
    <ul>
        <li>
            <a href="${contextPath}/administrator/train/createNewTrain"> Add new train</a>
        </li>
        <li>
            <a href="${contextPath}/administrator/train/searchTrain">Search train</a>
        </li>
        <li>
            <a href="${contextPath}/administrator/train/ViewAllTrains">Watch all trains</a>
        </li>
    </ul>
</div>
