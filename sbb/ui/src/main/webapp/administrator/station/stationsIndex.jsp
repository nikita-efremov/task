...
<div class = "additionalOptionsList">
    ...
    <ul>
        <li>
            <a href="${contextPath}/administrator/station/createNewStation"> Add new station</a>
        </li>
        <li>
            <a href="${contextPath}/administrator/station/ViewAllStations">Watch all stations</a>
        </li>
    </ul>
</div>
